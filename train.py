            ...
            if args.local_rank >= 0 :
                ...
                if global_step % args.i_print == 0 or global_step < 10:
                    ...
                    if ret['outputs_coarse_s'] is not None:
                        mse_error_s = img2mse(ret['outputs_coarse_s']['rgb'],ray_batch['rgb']).item()
                        scalars_to_log['train/coarse-loss-s'] =  mse_error_s
                        scalars_to_log['train/coarse-psnr-training-batch-s'] = mse2psnr( mse_error_s)
                    ...
                    if ret['outputs_fine'] is not None:
                        ...
                        if ret['outputs_fine_s'] is not None:
                            mse_error_s = img2mse(ret['outputs_fine_s']['rgb'],ray_batch['rgb']).item()
                            scalars_to_log['train/fine-loss-s'] =  mse_error_s
                            scalars_to_log['train/fine-psnr-training-batch-s'] = mse2psnr( mse_error_s)
