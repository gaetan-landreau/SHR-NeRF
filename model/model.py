...
from network.hypernetwork import HyperNetworkSymmLocal, HyperNetworksEnsemble
from network.hypernetwork_ResNet import HyperNetworkResNet
...
hypernetworks = {'base':HyperNetworkSymmLocal,
                 'ensemble':HyperNetworksEnsemble,
                 'resnet': HyperNetworkResNet}
...
class HyperNeRFResNetSymmLocal(object):
    def __init__(self, args, ckpts_folder):
        ...
        if not args.use_deepLabv3:
            ...
            self.feature_net = deepLabv3Plus(in_channels=3,
                                             out_channels=16*16, 
                                             encoder_name='resnet34',
                                             hypernetwork_type = self.hypernetwork_type,
                                             add_high_res_skip = args.add_high_res_skip,
                                             ).to(self.device)
